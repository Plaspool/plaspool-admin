...
describe('add-on copy', () => {
  ...
  it('reads a condition the way the picker shows it', () => {
    ...
    expect(describeCondition({ attribute: 'subtotal_minor', op: 'lte', value: 4_500_000 }, 'NGN')).toBe('Cart subtotal is at most NGN\u00A045,000.00');
  ...
  it('summarises the demo rules', () => {
    ...
    expect(describeRules([{ when: [], then: 'include', amountMinor: 20_000 }], 150_000, 'NGN')).toBe('Included at NGN\u00A0200.00 always');
