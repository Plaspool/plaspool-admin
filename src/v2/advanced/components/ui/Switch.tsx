...
// the scoped ui.css live under .advx, so the tooltip must render inside it.
const advxContainer = () =>
...
export function Tooltip({
  ...
  return (
    <RT.Root>
      ...
      {/* v2 port: container keeps the tooltip inside the .advx scope. */}
      <RT.Portal container={advxContainer()}>
